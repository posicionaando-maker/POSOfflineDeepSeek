// ============================================
// VERSIÓN DEFINITIVA - POS PRO
// ============================================

// CONFIGURACIÓN
const FORZAR_DATOS_LOCALES = false;  // Cambia a true SOLO para pruebas sin Google Sheets
...
// ============================================
// MATADOR DE SERVICE WORKERS (se ejecuta al inicio)
// ============================================
...
async function init() {
    ...
    try {
        ...
        // 4. SINCRONIZAR VENTAS PENDIENTES (si la función existe)
        if (typeof sincronizarVentasPendientes === 'function') {
            ...
            console.log('⚠️ sincronizarVentasPendientes no está definida aún');
        }
...
function cobrar() {
   // ============================================
// REGISTRAR VENTA (con envío a Google Sheets)
// ============================================
async function cobrar() {
    ...
    try {
        ...
        // Guardar venta pendiente para reintentar después
        ...
        // Opcional: vaciar carrito de todas formas
...
// ============================================
// GUARDAR VENTA PENDIENTE (para modo offline)
// ============================================
...
async function sincronizarVentasPendientes() {
    ...
    // Guardar las que aún no se pudieron
    localStorage.setItem('ventasPendientes', JSON.stringify(pendientes));
